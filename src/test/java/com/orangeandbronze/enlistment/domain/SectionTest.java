...
class SectionTest {
    ...
    void newSection_same_room_diff_sked() {
        ...
        new Section("A", DEFAULT_SUBJECT, MTH830to10, room, newFaculty(1, "Maria", "Rosario"));
        assertDoesNotThrow(() -> new Section("B", DEFAULT_SUBJECT, TF10to1130, room, newFaculty(1, "Maria", "Rosario")));
    }
    ...
    @Test
    void two_same_faculty_diff_sked() {
        Room room = new Room("X", 10);
    ...
    @Test
    void two_same_faculty_overlap_sked() {
        Room room = new Room("X", 10);
        new Section("A", DEFAULT_SUBJECT, MTH830to10, room, DEFAULT_FACULTY);
